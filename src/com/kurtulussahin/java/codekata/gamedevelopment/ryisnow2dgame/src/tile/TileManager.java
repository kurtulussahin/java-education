package com.kurtulussahin.java.codekata.gamedevelopment.ryisnow2dgame.src.tile;
...
public class TileManager {
    ...
    public TileManager(GamePanel gp){
        ...
        getTileImage();
        loadMap("src/com/kurtulussahin/java/codekata/gamedevelopment/ryisnow2dgame/res/maps/world01.txt");
    }
    ...
    public void getTileImage(){
        try{
            ...
            tile[0].image= ImageIO.read(new File(
                    "src/com/kurtulussahin/java/codekata/gamedevelopment/ryisnow2dgame/res/tiles/grass.png"));

            tile[1]=new Tile();
            tile[1].image= ImageIO.read(new File(
                    "src/com/kurtulussahin/java/codekata/gamedevelopment/ryisnow2dgame/res/tiles/wall.png"));
