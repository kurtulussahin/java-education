package com.kurtulussahin.JoshuaBlochEfectiveJavaTutorial.itema39.reflection;
...
public class TestReflection {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			Class<?> sınıf = Class.forName("com.kurtulussahin.JoshuaBlochEfectiveJavaTutorial.itema39.reflection.Metallica");
