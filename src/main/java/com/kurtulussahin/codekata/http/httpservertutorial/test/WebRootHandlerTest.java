...
import com.kurtulussahin.codekata.http.httpservertutorial.httpserver.core.io.WebRootHandler;
import com.kurtulussahin.codekata.http.httpservertutorial.httpserver.core.io.WebRootNotFoundException;
...
public class WebRootHandlerTest {
    ...
    private String webRootPath = "src/main/java/com/kurtulussahin/codekata/http/httpservertutorial/WebRoot";
    private String indexHtmlPath = "src/main/java/com/kurtulussahin/codekata/http/httpservertutorial/WebRoot/index.html";
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("src/main/java/com/kurtulussahin/codekata/http/httpservertutorial/WebRoot");
    ...
    void constructorBadPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("badPath/main/java/com/kurtulussahin/codekata/http/httpservertutorial/WebRoot");
            fail();
        }catch(WebRootNotFoundException e){
        }
    }
